...
unsafe extern "C" {
    ...
    /// - `c`: logical context.
    /// - `constr`: constructor.
    pub fn Z3_constructor_num_fields(c: Z3_context, constr: Z3_constructor) -> ::core::ffi::c_uint;
    ...
    ///
    /// The node `t1` must have a bit-vector sort.
    pub fn Z3_mk_bit2bool(c: Z3_context, i: ::core::ffi::c_uint, t1: Z3_ast) -> Option<Z3_ast>;
    /// Shift left.
    ///
    ...
    pub fn Z3_mk_lstring(c: Z3_context, len: ::core::ffi::c_uint, s: Z3_string) -> Option<Z3_ast>;
    /// Create a string constant out of the string that is passed in
    /// It takes the length of the string as well to take into account
    ...
    pub fn Z3_mk_seq_last_index(c: Z3_context, s: Z3_ast, substr: Z3_ast) -> Option<Z3_ast>;
    ...
    pub fn Z3_mk_seq_mapi(c: Z3_context, f: Z3_ast, i: Z3_ast, s: Z3_ast) -> Option<Z3_ast>;
    /// Create a fold of the function `f` over the sequence `s` with accumulator a.
    pub fn Z3_mk_seq_foldl(c: Z3_context, f: Z3_ast, a: Z3_ast, s: Z3_ast) -> Option<Z3_ast>;
    ...
    pub fn Z3_parser_context_add_decl(c: Z3_context, pc: Z3_parser_context, f: Z3_func_decl);
    ...
    pub fn Z3_goal_to_dimacs_string(c: Z3_context, g: Z3_goal, include_names: bool) -> Z3_string;
    ...
    pub fn Z3_solver_congruence_root(c: Z3_context, s: Z3_solver, a: Z3_ast) -> Option<Z3_ast>;
    ...
    pub fn Z3_solver_congruence_next(c: Z3_context, s: Z3_solver, a: Z3_ast) -> Option<Z3_ast>;
    ...
    pub fn Z3_solver_set_initial_value(c: Z3_context, s: Z3_solver, v: Z3_ast, val: Z3_ast);
    ...
    ///
    /// - `Z3_rcf_is_algebraic(ctx, a);`
    pub fn Z3_rcf_num_sign_conditions(c: Z3_context, a: Z3_rcf_num) -> ::core::ffi::c_uint;
    ...
    /// the initial Simplex tableau is recalibrated to attempt to follow the value assignment.
    pub fn Z3_optimize_set_initial_value(c: Z3_context, o: Z3_optimize, v: Z3_ast, val: Z3_ast);
